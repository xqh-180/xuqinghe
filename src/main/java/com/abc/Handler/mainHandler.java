...
import com.abc.Util.DupCheckMain;
import com.abc.beans.MyFile;
...
public class mainHandler {
    String path = "/upload/upload.jsp";

//   登录
        @RequestMapping("/signIn")
        public String doFirst(String name,String password) {
        if ("wang".equals(name) && "123456".equals(password)) {
    ...
    public String HomeworkDuplicateCheck(HttpServletRequest request){
        ...
        return "/js/HomeworkDuplicateCheck.jsp";
    }
    @RequestMapping("/SubmitAssignment")
    public String SubmitAssignment(){
        String url = "js/SubmitAssignment.jsp";
        return url;
    }
    ...
    public String Update(HttpServletRequest request){
        ...
        return "/display/ViewStudent.jsp";
    }
